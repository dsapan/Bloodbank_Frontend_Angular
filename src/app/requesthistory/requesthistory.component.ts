...
export class RequesthistoryComponent implements OnInit {
  ...
  {
    this.responses = this.donorService.acceptRequestForBlood(request_id);
    $("#acceptbtn").hide();
    $("#rejectbtn").hide();
    $("#acceptedbtn").show();
    $("#rejectedbtn").hide();
  ...
  rejectRequest(request_id : any)
  {
    this.responses = this.donorService.rejectRequestForBlood(request_id);
    $("#acceptbtn").hide();
    $("#rejectbtn").hide();
    $("#acceptedbtn").hide();
    $("#rejectedbtn").show();
